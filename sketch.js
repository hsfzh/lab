...
6. 이 게임의 최종 목표는 '속삭임의 숲' 깊은 곳에 있는 보스 몬스터를 물리치는 것입니다. 플레이어가 약 8~12번 정도의 선택과 탐험을 거치면 마침내 보스와 조우하게 하고, 보스전의 결과에 따라 명확한 엔딩(해피엔딩 또는 배드엔딩)을 내어 게임을 마무리하세요.
...
let startPrompt = {
  ...
  parts: [{
    text: `[게임 규칙]
1. 이 게임의 최종 목표는 '속삭임의 숲' 깊은 곳에 있는 보스 몬스터를 물리치는 것입니다.
2. 현재 게임 상황을 AI가 설명해줍니다.
3. 설명에 맞춰 주어진 선택지를 고르거나 원하는 행동을 입력하십시오.
4. 선택지를 고를 시에는 "1" 혹은 "1번" 이렇게 대답하십시오.
5. 선택지에 없는 원하는 행동을 할 때는 행동을 명확하게 상황에 맞춰서 입력하십시오.
6. 즐겁게 탐험하십시오!`
  }]
};
let scrollOffset = 0;
